package com.verizon.delphi.mq.service;
...
public class MQService {
	...
	private static final String HOSTNAME = "MVSFNE2.VZBI.COM";
	private static final int PORT = 1418;
	private static final String CHANNEL = "CSQ2.TO.E2ECLR";
	private static final String QUEUE_MANAGER = "CSQ2";
	private static final String HOST = "MVSFNE2.VZBI.COM"; // Host name or IP address
	...
	private static final String QUEUE_NAME = "";// Queue that the application uses to put and get messages to and from
	...
	public MQQueueManager connectToQueueManager(String queueMgrName, Hashtable<String, Object> properties) {
		try {
			...
			LOGGER.info("Connected to queue manager: {}, {}, {}", queueMgrName, queueManager.isConnected(),
					queueManager.isOpen());
			sendMessage(queueManager);
			executors.execute(() -> receiveMessage(queueManager, "LQ.RESOURCE.MANAGER.DATA"));
	...
	public void sendMessage(MQQueueManager queueManager) {
		// TODO Auto-generated method stub
		int openOptions = MQConstants.MQOO_INPUT_AS_Q_DEF | MQConstants.MQOO_OUTPUT;
		try {
			LOGGER.info("Start sendMessage");
			MQQueue queue = queueManager.accessQueue("LQ.RESOURCE.MANAGER.DATA", openOptions);
			...
			String payload;// = "<message>Testing of message sending to LQ.RESOURCE.MANAGER.DATA queue
							// </message>";
			payload = "<?xml version=\"1.0\"?><CLR_REQUEST><CIRCUIT_ID>W1B60748</CIRCUIT_ID><VIEW>P</VIEW><SHORT_LONG>S</SHORT_LONG><EQUIPMENT>Y</EQUIPMENT><SO_NOTES>Y</SO_NOTES><CI_NOTES>Y</CI_NOTES><CPE_NOTES>Y</CPE_NOTES><USER_ID>10.118.226.70</USER_ID><APPROVAL_LEVEL>A168</APPROVAL_LEVEL></CLR_REQUEST>";
...
//			putMessage.format = CMQC.MQFMT_STRING;
			...
			putMessage.replyToQueueName = "RGSH.REPLY.QUEUE.0001";
			putMessage.replyToQueueManagerName = "CSQ2";
